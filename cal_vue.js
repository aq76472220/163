...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function(options,callBack) {
		var that_h = $(this);
		...
		var date_h = new Date(),year_h = date_h.getFullYear();
		...
		function closeIt (el, datepicker, dateObj) { 
			...
			callBack && callBack(jQuery.fn.simpleDatepicker.formatOutput(dateObj))
		}
			...
			if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
				...
				jQuery(this).click(function (ev) {
					...
					if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
						...
						//$this.bind('blur',function(){ setTimeout(function(){closeIt($this, datepicker);},200)});
						//datepicker.bind('mouseleave',function(){setTimeout(function(){closeIt($this, datepicker);},500)})
